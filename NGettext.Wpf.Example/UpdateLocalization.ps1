# # TODO: will need to verify these, any migration path breaking changes since the baseline version
# # TODO: latest at the time of this migration, https://nuget.org/packages/Gettext.Tools/0.22.5
...
$env:Path += ";..\packages\Gettext.Tools.0.22.5\tools\bin"
